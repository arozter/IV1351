...
ALTER TABLE individual ADD CONSTRAINT PK_individual PRIMARY KEY (individual_id);
...
CREATE TABLE student (
 ...
 contactperson_phonenumber VARCHAR(20),
...
ALTER TABLE lesson ADD CONSTRAINT FK_lesson_1 FOREIGN KEY (individual_id) REFERENCES individual (individual_id);
